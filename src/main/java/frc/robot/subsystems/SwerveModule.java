...
public class SwerveModule extends SubsystemBase{
    ...
    public SwerveModule(int driveMotorId, int turningMotorId, boolean driveMotorReversed, boolean turningMotorReversed,
        ...
        System.out.println("Encoder Reading " + turningMotorId + " : " + (absoluteEncoder.getPosition().getValue().magnitude() * 2 * Math.PI));
    }
    ...
    public double getTotalCurrent() {
        double driveMotorCurrent = driveMotor.getOutputCurrent();
        double turningMotorCurrent = turningMotor.getOutputCurrent();
        return driveMotorCurrent + turningMotorCurrent;
    }
